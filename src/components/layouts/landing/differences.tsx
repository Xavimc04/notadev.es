...
export default function Differences() {
    ...
    return <div className="flex-wrap xl:flex-nowrap lg:flex-1 flex justify-center p-5 lg:justify-between gap-5 self-center md:w-2/3 xl:w-full">
        {
...
function Difference({
    ...
    return <Card
        className="w-[80%] md:w-[45%] xl:w-1/4" 
    >
