...
export default function Page() {
    return <main className="flex flex-col items-center">
        ...
        {/* @ Waves wallpaper */}
        <div className="fixed flex flex-col top-0 -z-10">
            <div className="h-96 md:h-60 lg:h-48 xl:h-48 block 2xl:h-32 bg-primary"></div>
        ...
        <div className="w-[80%] 2xl:w-2/3 relative mt-32 bg-white px-10 overflow-visible flex justify-between">
            <section className="w-full xl:w-1/2 flex flex-col items-center xl:items-start gap-5">
                <h1 className="text-8xl py-10 font-bold text-center xl:text-left break-keep">
